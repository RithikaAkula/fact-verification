...
def bm25_retrieval(data, use_raw_texts, use_doc_indices):
...
if __name__ == "__main__":
    ...
    input_data_path = preprocessing_path + ('/preprocessing/processed_fever/fever-train-split.json' if on_complete_fever else '/preprocessing/processed_fever/fever-1000.json')
    with open(input_data_path) as f:
        data = json.load(f)

    # PERFORM RETRIEVAL
    top_k_docs = bm25_retrieval(data, use_raw_texts, use_doc_indices)
    ...
    actual, predicted = extract_actual_predicted_ids(top_k_docs)
